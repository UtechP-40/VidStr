...
const addComment = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        res.status(error.statusCode || 500).json(
            new ApiResponse(error.statusCode || 500, {}, error?.message || "Something went wrong while adding comment")
        )
    }
})
...
const updateComment = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        res.status(error.statusCode || 500).json(
            new ApiResponse(error.statusCode || 500, {}, error?.message || "Something went wrong while updating comment")
        )
    }
})
